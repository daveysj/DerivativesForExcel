...
//int far _cdecl __declspec(dllimport) Excel4(int xlfn, LPXLOPER operRes, int count,... );
int far _cdecl Excel4(int xlfn, LPXLOPER operRes, int count,... );
/* followed by count LPXLOPERs */

//int far pascal __declspec(dllimport) Excel4v(int xlfn, LPXLOPER operRes, int count, LPXLOPER far opers[]);
//int far pascal __declspec(dllimport) XLCallVer(void);
